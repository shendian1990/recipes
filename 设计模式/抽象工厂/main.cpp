...
int main()
{
	...
	// 宝马
	pFactory = AbstractFactory::CreateFactory(AbstractFactory::FACTORY_TYPE::BMW_FACTORY);
	...
	// 奥迪
	pFactory = AbstractFactory::CreateFactory(AbstractFactory::FACTORY_TYPE::AUDI_FACTORY);
	pCar = pFactory->CreateCar();
	pBike = pFactory->CreateBike();
